 ...
 *  unset, empty, non-numeric, zero, or negative — the scheduler stays
 *  off in any of those cases rather than guessing. */
...
export function startCleanupScheduler(): void {
  const hours = parseIntervalHours(process.env.MOOR_CLEANUP_DANGLING_INTERVAL_HOURS);
